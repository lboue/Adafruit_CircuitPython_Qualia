...
"""
`adafruit_qualia.displays.bar400x960`
================================================================================

4.58" 400x960 Bar DotClock Display Class
...
* `Rectangle Bar RGB TTL TFT Display - 3.99" 400x960 No Touchscreen
  <https://www.buydisplay.com/bar-type-3-99-inch-400x960-ips-tft-lcd-display-spi-rgb-interface>`_
...
class Bar400x960(DotClockDisplay):
    """ER-TFT3.99-1 display driver"""
